...
class Custom(Imdb):
    ...
    """
    def __init__(self, image_set, dataset_path, shuffle=False, is_train=False):
    ...
    def evaluate_detections(self, detections):
        ...
        result_dir = os.path.join(self.data_path, 'results')
    ...
    def get_result_file_template(self):
        ...
        ----------
            a string template
        """
        res_file_folder = os.path.join(self.data_path, 'results')
