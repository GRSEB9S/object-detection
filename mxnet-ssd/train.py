...
def parse_args():
    ...
    # data set params
    parser.add_argument('--dataset', dest='dataset', help='which dataset to use', choices=['pascal', 'custom'], type=str)
    parser.add_argument('--image-set', dest='image_set', help='train set, can be trainval or train', default='trainval', type=str)
    parser.add_argument('--year', dest='year', help='can be 2007, 2012', default='2007,2012', type=str)
    parser.add_argument('--val-image-set', dest='val_image_set', help='validation set, can be val or test', default='test', type=str)
    parser.add_argument('--val-year', dest='val_year', help='can be 2007, 2010, 2012', default='2007', type=str)
    ...
    parser.add_argument('--network', dest='network', type=str, default='vgg16_reduced',
                        choices=['vgg16_reduced', 'caffenet', 'squeezenet', 'resnet', 'spectral'], help='which network to use')
    ...
    parser.add_argument('--wd', dest='weight_decay', type=float, default=0.0001, help='weight decay')
    ...
    parser.add_argument('--lr-epoch', dest='lr_refactor_epoch', type=int, default=50, help='refactor learning rate every N epoch')
    parser.add_argument('--lr-ratio', dest='lr_refactor_ratio', type=float, default=0.9, help='ratio to refactor learning rate')
