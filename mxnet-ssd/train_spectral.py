...
import os
import sys
from train.train_spectral_net import train_tir_net
import datetime
...
def parse_args():
    ...
    parser.add_argument('--wd', dest='weight_decay', type=float, default=0.00001, help='weight decay')
...
if __name__ == '__main__':
    ...
    if args.dataset in ['kaist', 'custom']:
    ...
    if args.dataset == 'cvc':
        ...
        mean_tir = [142.597139797]
        std_tir = [55.7261941953]
