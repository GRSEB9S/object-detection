...
class Piropo(Imdb):
    ...
    """
    Implementation of Imdb for Piropo dataset
    ...
    def __init__(self, image_set, year, piropo_path, shuffle=False, is_train=False):

        super(Piropo, self).__init__('piropo')

        self.image_set = image_set
        self.year = year
        self.dataset_path = piropo_path
        self.data_path = os.path.join(piropo_path)
        self.extension = '.jpg'
    ...
    def evaluate_detections(self, detections):
        ...
        # year_folder = os.path.join(self.dataset_path, 'results', 'VOC' + self.year)
        # if not os.path.exists(year_folder):
        #     os.mkdir(year_folder)
        #
        # res_file_folder = os.path.join(self.dataset_path, 'results', 'VOC' + self.year, 'Main')
        #
    ...
    def get_result_file_template(self):
        ...
        filename = self.image_set + '_{:s}.txt'
    ...
    def do_python_eval(self):
        ...
        cache_dir = os.path.join(self.data_path, 'cache_dir_annotations')
        aps = []
        ...
        for cls_ind, cls in enumerate(self.classes):
            filename = self.get_result_file_template().format(cls)
            rec, prec, ap = voc_eval(filename, annopath, imageset_file, cls, cache_dir, ovthresh=0.5, use_07_metric=use_07_metric)
            aps += [ap]
