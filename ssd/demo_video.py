...
def parse_args():
    ...
    parser.add_argument('--video-file', dest='video_file', help='video file path', type=str)
    parser.add_argument('--save-video', dest='save_video', help='the path of the video to save', type=str)
...
if __name__ == '__main__':
    ...
    args.video_file = 'Visible_V003.avi'
    ...
    while (cap.isOpened()):
        ...
        if ret:
            ...
            print res.shape
            result = visualize_detection_img(img2, res, spend_time, color_cls, CLASSES, thresh=0.1)
            out.write(result)
        else:
            break
