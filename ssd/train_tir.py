...
def parse_args():
    ...
    # data set params
    parser.add_argument('--dataset', dest='dataset', help='which dataset to use', choices=['pascal', 'kaist', 'custom'], type=str)
    ...
    parser.add_argument('--network', dest='network', type=str, default='resnet_tir', help='which network to use')
    ...
    parser.add_argument('--lr', dest='learning_rate', type=float, default=0.00005, help='learning rate')
